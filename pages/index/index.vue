		...
		<view class="banner">
			...
			indicator-active-color="#fff" autoplay>
				<swiper-item v-for="item in bannerList" :key="item._id">
					<navigator class="like" v-if="item.target == 'miniProgram'" target="miniProgram" :url="`/pages/classList/classList?${item.url}`">
			...
			<common-title>
				...
				<template #custom>
					<view class="date">
						...
						<view class="text">
							<uni-dateformat :date="Date.now()" format="M.dd"></uni-dateformat>
						</view>
					</view>
				</template>
			</common-title>
...
onShareTimeline ((e) => {
	return {
		title: "虾米壁纸",
		imageUr: '/static/images/xxmLogo.jpg'
	}
})
