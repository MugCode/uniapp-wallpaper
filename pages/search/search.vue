...
//搜索历史词
const historySearch = ref(uni.getStorageInfoSync("historySearch") || []);
...
const onSearch = ()=>{
	...
	uni.setStorageInfoSync("historySearch", historySearch.value);
...
const searchData = async() => {
	try{
		...
		uni.setStorageInfoSync("storgClassList",classList.value);
